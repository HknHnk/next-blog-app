...
const NoteItem = ({ title, description, category, image, id, pdf }) => {
    ...
    return (
        <div className='max-w-[330px] sm:max-w-[300px] bg-white border border-black hover:shadow-[-7px_7px_0px_#000000]'>
            ...
            <div className='p-5'>
                ...
                <Link href={{ pathname: `/note/${id}`, query: { pdf } }} className='inline-flex items-center py-2 font-semibold text-center'>
